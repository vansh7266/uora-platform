...
export const DEMO_ANOMALIES: AnomalyEvent[] = [
  { timestamp: Date.now() - 120_000, score: 0.72, type: "latency_spike", team: "Flow Traders" },
  { timestamp: Date.now() - 240_000, score: 0.58, type: "order_imbalance", team: "Virtu Financial" },
  { timestamp: Date.now() - 480_000, score: 0.44, type: "throughput_drop", team: "IMC Trading" },
];
